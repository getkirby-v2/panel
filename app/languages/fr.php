...
return array(
  ...
  'data' => array(
    ...
    'installation.check.headline' => 'Installation du panel de Kirby',
    ...
    'installation.check.error' => 'Il y a des problèmes!',
    'installation.check.error.accounts' => 'Le répertoire "/site/accounts" n’est pas ouvert en écriture',
    'installation.check.error.avatars' => 'Le répertoire "/assets/avatars" n’est pas ouvert en écriture',
    'installation.check.error.blueprints' => 'Veiller ajouter un répertoire "/site/blueprints"',
    'installation.check.error.content' => 'Le répertoire "content/", les sous-répertoires et les fichiers qu’il contient doivent être ouverts en écriture.',
    'installation.check.error.thumbs' => 'Le répertoire "thumbs/" doit être ouvert en écriture.',
    ...
    'pages.add.error.template' => 'Vous n’avez pas choisi de template',
    ...
    'subpages.index.invisible.help' => 'Glicer ici une page pour la rendre invisible.',
    ...
    'users.form.error.permissions.title' => 'Le répertoir des comptes n’est pas ouvert en écriture',
    'users.form.error.permissions.text' => 'Vérifiez que le répertoire "/site/accounts" existe et est ouvert en écriture.',
    ...
    'users.avatar.error.folder.headline' => 'Le répertoire avatar n’est pas ouvert en écriture',
