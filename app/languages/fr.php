...
return array(
  ...
  'data' => array(
    ...
    'installation.check.headline' => 'Installation l’interface graphique de Kirby',
    ...
    'installation.check.error.accounts' => 'Le répertoire <strong>/site/accounts</strong> n’est pas accessible en écriture',
    'installation.check.error.avatars' => 'Le répertoire <strong>/assets/avatars</strong> n’est pas accessible en écriture',
    'installation.check.error.blueprints' => 'Veiller ajouter un répertoire <strong>/site/blueprints</strong>',
    'installation.check.error.content' => 'Le répertoire <strong>content/</strong>, les sous-répertoires et les fichiers qu’il contient doivent être ouverts en écriture.',
    'installation.check.error.thumbs' => 'Le répertoire <strong>thumbs/</strong> doit être accessible en écriture.',
    ...
    // login
    'login' => 'Connexion',
    'login.welcome' => 'Veillez vous autentifier avec votre nouveau compte',
    ...
    'pages.show.error.permissions.title' => 'La page ne peut être enregistrée',
    ...
    'pages.url.uid.label' => 'Identifiant pour l’URL de l’article',
    ...
    'pages.delete.error.home.text' => 'Vous essayez de supprimer la page d’accueil. Ce n’est pas possible et cela aurait des conséquences facheuses.',
    'pages.delete.error.error.headline' => 'La page d’erreur ne peut être supprimée',
    'pages.delete.error.error.text' => 'Vous êtes en train d’essayer de supprimer la page d’erreur. Ce n’est pas possible et cela aurait des conséquences facheuses.',
    'pages.delete.error.children.headline' => 'La page ne peut être supprimée',
    'pages.delete.error.children.text' => 'Cette page à des pages secondaires. Veillez supprimer les pages associée au préalable.',
    ...
    'pages.search.help' => 'Recherche de page par URL. Naviguez entre les résultats avec les flêches “haut” et “bas” du clavier, puis appuyez sur la touche “Entrée” pour aller à la page sélectionnée.',
    'pages.search.noresults' => 'Il n’y a pas de réponse à votre recherche. Veillez essayer de nouveau avec une URL différente.',
    ...
    'subpages.error.missing' => 'La page ne peut être trouvée',
    ...
    'files.index.upload.first.button' => 'Télécharger un premier fichier',
    ...
    'files.show.error.rename' => 'Le fichié n’a pu être renommé',
    'files.show.error.form' => 'Merci de remplir correctement chaque champ du formulaire',
    'files.upload.drop' => 'Glisser ici un fichier…',
    'files.upload.click' => '…ou cliquer pour télécharger un fichier depuis votre ordinateur',
    'files.replace.drop' => 'Glisser ici un fichier…',
    'files.replace.click' => '…or click to replace',
    'files.replace.error.type' => 'Le fichier téléchargé doit être du mêm type',
    'files.delete.headline' => 'Voulez-vous réellement supprimer ce fichier ?',
    'files.error.missing.page' => 'Cette page n’a pu être trouvée',
    'files.error.missing.file' => 'Ce fichier n’a pu être trouvé',

    // users
    'users' => 'Utilisateurs',
    'users.index.headline' => 'Tous les utilisateurs',
    'users.index.add' => 'Ajouter',
    ...
    'users.form.firstname.label' => 'Nom de famille',
    'users.form.lastname.label' => 'Prénom',
    ...
    'users.form.avatar.upload' => 'Télécharger une image de profil',
    'users.form.avatar.replace' => 'Remplacer l’image du profil',
    'users.form.avatar.delete' => 'Supprimer l’image du profil',
    'users.form.back' => 'Retour à la page de l’utilisateur',
    'users.form.error.password.confirm' => 'Merci de confirmer le mot de passe',
    ...
    'users.delete.headline' => 'Désirez-vous vraiment supprimer ce compte ?',
    'users.delete.error' => 'Le compte utilisateur ne peut pas être supprimé',
    'users.avatar.drop' => 'Glisser ici un fichier image…',
    'users.avatar.click' => '…ou cliquer pour télécharger depuis votre ordinateur',
    'users.avatar.error.type' => 'Vous pouvez uniquement télécharger des fichiers JPG, PNG et GIF',
    'users.avatar.error.folder.headline' => 'Le répertoire avatar n’est pas accessible en écriture',
    'users.avatar.error.folder.text' => 'Veillez créer le répertoire <strong>/assets/avatars/</strong> et l’ouvrir en écriture pour pouvoir charger une vignette pour le compte.',
    'users.avatar.delete.error' => 'L’image du profil ne peut être supprimée',
    ...
    'fields.structure.add.first' => 'Ajouter un premier billet',
    'fields.structure.empty' => 'Aucun billet pour l’instant.',
    ...
    'editor.link.text.help' => 'Le texte du lien est optionel',
    ...
    'editor.email.text.help' => 'Le texte du lien est optionel',
    'editor.file.empty' => 'Cette page n’a aucun fichié attaché',
    'editor.image.empty' => 'Cette page n’a aucun fichié image attaché',
