...
return array(
  ...
  'data' => array(
    ...
    // routes
    'routes.error.invalid' => 'Geçersiz Panel Adresi',
    
    // controllers
    'controller.error.invalid' => 'Geçersiz denetleyici',
    'controller.error.action' => 'Geçersiz eylem',
    
    // views
    'view.error.invalid' => 'Geçersiz görünüm: ',
    ...
    'login.log.error.permissions' => 'Giriş günlük kayıt dosyası yazılabilir değil',

    // logout
    'logout' => 'Çıkış Yap',
    
    // topbar
    'topbar.error.class.definition' => 'Sınıfın üstbar tanımlaması eksik: ',

    // dashboard
    'dashboard' => 'Kontrol Paneli',
    'dashboard.index.pages.title' => 'Sayfalar',
    'dashboard.index.pages.edit' => 'Düzenle',
    'dashboard.index.pages.add' => 'Ekle',
    ...
    // site
    'site.delete.error' => 'Site silinemez',
    ...
    'pages.add.title.label' => 'Yeni bir alt sayfa ekle',
    ...
    'pages.add.error.create' => 'Sayfa oluşturulamadı',
    'pages.add.error.title' => 'Başlık bulunamadı',
    'pages.add.error.template' => 'Şablon bulunamadı',
    'pages.add.error.max.headline' => 'Yeni sayfalar eklemeye izin verilmedi',
    ...
    'pages.url.home.error.error' => 'Anasayfa ve hata sayfalarının adresleri değiştirilemez',
    ...
    'pages.toggle.error.error' => 'Hata sayfasının durumu değiştirilemez',
    ...
    'subpages.index.add' => 'Yeni bir alt sayfa ekle',
    'subpages.index.add.first.text' => 'Bu sayfanın henüz bir alt sayfası yok',
    'subpages.index.add.first.button' => 'İlk alt sayfanı ekle',
    ...
    'subpages.add.error' => 'Bu sayfaya alt sayfa eklenemez',
    'subpages.add.error.more' => 'Bu sayfaya daha fazla alt sayfa eklenemez',
    ...
    'files.index.error.disabled' => 'Bu sayfaya dosya eklenemez',
    'files.add.error.max' => 'Bu sayfa için maximum dosya limitine ulaşıldı',
    'files.add.error.extension.missing' => 'Uzantısı olmayan dosya yüklenemez',
    'files.add.error.extension.forbidden' => 'İzin verilmeyen dosya uzantısı',
    'files.add.error.mime.forbidden' => 'İzin verilmeyen dosya tanımlayıcısı',
    'files.add.error.htaccess' => 'htaccess dosyası yüklenemez',
    'files.add.error.invisible' => 'Görünmez dosyalar yüklenemez',
    'files.add.blueprint.type.error' => 'Sayfanın desteklediği formatlar: ',
    'files.add.blueprint.size.error' => 'Sayfanın izin verdiği boyut: ',
    ...
    'users.form.error.update.rights' => 'Bu kullanıcıyı güncellemek için yetkiniz yok',
    ...
    'users.delete.error.permission' => 'Kullanıcıları silme yetkiniz yok',
    'users.delete.error.permission.single' => 'Bu kullanıcıyı silme yetkiniz yok',
    'users.delete.error.lastadmin' => 'Son yönetici kullanıcıyı silemezsiniz',
    ...
    'users.avatar.error.permission' => 'Avatarı değiştirme yetkiniz yok',
    'users.avatar.delete.error' => 'Profil resmi silinemedi',
    'users.avatar.delete.error.permission' => 'Bu kullanıcının avatarını silme yetkiniz yok',
    'users.avatar.delete.success' => 'Profil resmi silindi',
    'users.avatar.missing' => 'Bu kullanıcının avatarı yok',
    'users.error.missing' => 'Kullanıcı bulunamadı',
    'user.error.lastadmin' => 'Tek yönetici sensin. Bu değiştirilemez',
    
    // form
    'form.error.missing' => 'Form bulunamadı',
    'form.construct.error.invalid' => 'Geçersiz form kurucu metodu',
    ...
    'fields.structure.add' => 'Ekle',
    'fields.structure.add.first' => 'İlk girdini ekle',
    'fields.structure.empty' => 'Henüz bir girdi yok',
    'fields.structure.entry.error' => 'Öğe bulunamadı',
    'fields.structure.cancel' => 'İptal',
    'fields.structure.save' => 'Kaydet',
    'fields.structure.edit' => 'Düzenle',
    'fields.structure.delete' => 'Sil',
    'fields.structure.delete.label' => 'Bu girdiyi silmek istediğinizden emin misiniz?',
    ...
    'fields.error.missing.controller' => 'Alan denetleyici dosyası eksik',
    'fields.error.missing.class' => 'Alan kontrol sınıfı eksik',
    'fields.error.route.invalid' => 'Geçersiz alan rotası',
    'fields.error.extended' => 'Bu alan genişletilemez',
    ...
    // autocomplete
    'autocomplete.method.error' => 'Geçersiz otomatik doldurma metodu',
    
    // blueprints
    'blueprints.error.default.missing' => 'Varsayılan taslak dosyası eksik',
