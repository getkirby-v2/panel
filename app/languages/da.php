...
return array(
  ...
  'data' => array(
    ...
    'dashboard.index.metatags.title' => 'Website indstillinger',
    ...
    'metatags.files' => 'Website filer',

    // pages
    'pages.show.settings' => 'Side indstillinger',
    'pages.show.preview' => 'Se eksempel',
    'pages.show.changeurl' => 'Ændre URL',
    'pages.show.invisible' => 'Status: usynlig',
    'pages.show.visible' => 'Status: synlig',
    'pages.show.changes.text' => 'Du har ugemte ændringer!',
    'pages.show.changes.button' => 'Kassér',
    ...
    'pages.show.error.permissions.text'  => 'Kontroller venligst skriverettigheder for content mappen samt alle filer.',
    ...
    'pages.toggle.publish' => 'Ønsker du virkelig at ændre denne sides status til **synlig?**',
    'pages.toggle.hide' => 'Ønsker du virkelig at ændre denne sides status til **usynlig?**',
    ...
    'pages.delete.error.home.text' => 'Du forsøger at slette forsiden. Dette er ikke muligt da det ville lede til et uønsket oplevelse.',
    'pages.delete.error.error.headline' => 'Fejlsiden kan ikke slettes',
    'pages.delete.error.error.text' => 'Du forsøger at slette fejlsiden. Dette er ikke muligt da det ville lede til et uønsket oplevelse.',
    ...
    'pages.search.help' => 'Søg efter sider udfra URL. Naviger igennem søgeresultater med dine op- og ned-piletaster og tryk enter for at hoppe til den valgte side.',
    ...
    'subpages.error.missing' => 'Siden kunne ikke findes',
    ...
    'users.avatar.error.type' => 'Du kan kun uploade JPG, PNG og GIF filer',
    'users.avatar.error.folder.headline' => 'Avatar mappen er ikke skrivbar',
    'users.avatar.error.folder.text' => 'Opret venligst mappen <strong>/assets/avatars</strong> og sørg for at den er skrivbar for at kunne uploade profilbilleder.',
