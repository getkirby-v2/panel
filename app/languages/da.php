...
return array(
  ...
  'data' => array(
    ...
    'installation.check.headline' => 'Kirby Panel Installering',
    'installation.check.text' => 'Kirby fandt følgende problemer under installeringen…',
    'installation.check.retry' => 'Prøv ogen',
    ...
    'installation.signup.username.label' => 'Opret din første Create your first konto',
    ...
    'dashboard.index.pages.add' => 'Tilføj',
    'dashboard.index.site.title' => 'Dit website\'s URL',
    'dashboard.index.account.title' => 'Din konto',
    'dashboard.index.account.edit' => 'Rediger',
    'dashboard.index.metatags.title' => 'Website variabler',
    'dashboard.index.metatags.edit' => 'Rediger',
    'dashboard.index.history.title' => 'Dine seneste ændringer',
    'dashboard.index.history.text' => 'Dine seneste ændrede sider vil blive vist her for at gøre det nemt at finde dem igen senere.',

    // metatags
    'metatags' => 'Website variabler',
    'metatags.back' => 'Tilbage til dashboard',

    // pages
    'pages.show.settings' => 'Side indstillinger',
    ...
    'pages.show.error.permissions.text'  => 'Kontroller venligst skrivetilladelser for content mappen samt underliggende filer.',
    ...
    'pages.add.url.label' => 'URL-tillæg',
    ...
    'pages.add.error.max.headline' => 'Ikke flere sider er tilladt',
    'pages.add.error.max.text' => 'Maksimum antallet af undersider for denne side er nået.',
    'pages.url.uid.label' => 'URL-tillæg',
    'pages.url.uid.label.option' => 'Generer udfra titel',
    'pages.url.error.exists' => 'En side med samme tillæg eksisterer allerede',
    'pages.url.error.move' => 'URL-tillæget kunne ikke ændres',
    ...
    'subpages.index.invisible.help' => 'Træk synliige sider hertil for at usortere dem og gøre dem usynlige.',
    ...
    'files.index.upload' => 'Tilføj en ny fil',
    'files.index.upload.first.text' => 'Denne side har ingen filer endnu',
    'files.index.upload.first.button' => 'Tilføj den første fil',
    ...
    'files.show.error.form' => 'Udfyld venligst alle felterne korrekt',
    'files.upload.drop' => 'Træk filer hertil…',
    'files.upload.click' => '…eller klik for at vælge',
    ...
    'users.form.avatar.upload' => 'Tilføj profilbillede',
    ...
    'users.avatar.delete.success' => 'Profilbilledet blev slettet',
    'users.error.missing' => 'Brugeren kunne ikke findes',

    // form fields
    'fields.required' => 'Kræves',
    ...
    'fields.toggle.on' => 'Tænd',
    'fields.toggle.off' => 'Sluk',
