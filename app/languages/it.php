...
return array(
  ...
  'data'    => array(
    ...
    'installation.check.error'                  => 'Ci sono dei problemi!',
    ...
    'installation.check.error.content'          => 'La cartella /content e tutto il suo contenuto devone disporre dei permessi di scrittura.',
    ...
    'metatags.back' => 'Indietro al dashboard',
    ...
    'pages.show.subpages.title'             => 'Sottopagine',
    ...
    'pages.show.files.empty'                => 'Questa pagina non ha files',
    'pages.show.error.permissions.title'    => 'Questa pagina non ha i permessi di scrittura',
    ...
    'pages.show.error.notitle.title'        => 'Nello schema non è previsto un campo per il titolo',
    'pages.show.error.notitle.text'         => 'Aggiungi un titolo e riprova',
    'pages.show.error.notitle.retry'        => 'Riprova',
    'pages.show.error.form'                 => 'Compila tutti i campi correttamente',

    'pages.add.title.label'                 => 'Aggiungi nuova pagina',
    ...
    'pages.search.help'                     => 'Cerca le pagine indicando l\'URL. Naviga tra i risultati della ricerca con i tasti freccia e premi enter per visualizzare la pagina selezionata.',
    ...
    'subpages.index.headline'         => 'Sottopagine in',
    'subpages.index.back'             => 'Indietro',
    'subpages.index.add'              => 'Aggiungi nuova sottopagina',
    'subpages.index.add.first.text'   => 'Questa pagina non ha ancora sottopagine',
    'subpages.index.add.first.button' => 'Aggiungi la prima sottopagina',
    'subpages.index.visible'          => 'Sottopagine visibili',
    'subpages.index.visible.help'     => 'Trascina qui una pagina nascosta per renderla visibile.',
    'subpages.index.invisible'        => 'Pagine nascoste',
    'subpages.index.invisible.help'   => 'Trascina qui una pagina visibile per nasconderla.',
    'subpages.error.missing'          => 'La sottopagina non è stata trovata',
    ...
    'files.index.upload.first.text'   => 'Questa pagina non contiene nessun file',
    ...
    'files.show.error.rename'         => 'Il file non è potuto essere rinominato',
    ...
    'users.form.username.placeholder'       => 'nome utente',
    ...
    'users.form.back'                       => 'Ritorna agli utenti',
    ...
    'users.form.error.permissions.title'    => 'La cartella degli account non ha i permessi di scrittura.',
    'users.form.error.permissions.text'     => 'Verifica che la cartella /site/accounts esista e abbia i permessi di scrittura.',
    'users.delete.headline'                 => 'Sei sicuro di voler eliminare questo utente?',
    'users.delete.error'                    => 'L\'utente non può essere eliminato essere eliminiato',
    ...
    'users.avatar.error.folder.text'        => 'Crea la catella <strong>/assets/avatars</strong> e assegnale i permessi di scrittura per caricare le immagini di profilo.',
    ...
    'fields.structure.empty'                => 'Non vi sono ancora elementi.',
    ...
    'editor.email.address.label'        => 'Indirizzo email',
    ...
    'editor.file.empty'                 => 'In questa pagina non vi sono files',
    'editor.image.empty'                => 'In questa pagina non vi sono immagini',
