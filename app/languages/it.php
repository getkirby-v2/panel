...
return array(
  ...
  'data'    => array(
    ...
    'dashboard.index.pages.edit'      => 'Modifica',
    ...
    'dashboard.index.history.title'   => 'Le tue ultime modifiche',
    ...
    'pages.show.subpages.edit'              => 'Modifica',
    'pages.show.subpages.add'               => 'Aggiungi',
    'pages.show.subpages.empty'             => 'Questa pagina non ha sottopagine',
    'pages.show.files.title'                => 'File',
    'pages.show.files.edit'                 => 'Modifica',
    ...
    'pages.delete.error.error.text'         => 'Stai cercando di eliminare la pagina di errore. Quest\'operazione non è possibile e potrebbe causare effetti indesiderati.',
    ...
    'users.avatar.error.folder.text'        => 'Crea la cartella <strong>/assets/avatars</strong> e assegnale i permessi di scrittura per caricare le immagini dei profili.',
