...
return array(
  ...
  'data' => array(
    ...
    'installation.check.text' => 'Во время установки Kirby фозникли следующие проблемы…',
    ...
    'pages.url.uid.label' => 'понятная ссылка (ЧПУ)',
    'pages.url.uid.label.option' => 'Сгенерировать из названия',
    ...
    'pages.search.help' => 'Поиск страниц по ссылкам. Для перемещения по результатам поиска используйте стрелки на клавиатуре ВВЕРХ и ВНИХ. Для открытия страницы, нажмите ВВОД.',
    ...
    'files.upload.click' => '…или кликните для выбора - что закачать',
    'files.replace.drop' => 'Перетащите файлы сюда…',
    'files.replace.click' => '…или кликните для выбора - что заменить',
    ...
    'users.avatar.click' => '…или кликните для выбора - что закачать',
