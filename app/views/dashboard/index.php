    ...
    <div class="section white dashboard-section">
      ...
      <div class="field">
        ...
        <div class="dashboard-box">
          <div class="text">
            <p>
              <?php _l('dashboard.index.license.warning') ?>
            </p>
            <p>
              <?php _l('dashboard.index.license.support') ?> <a target="blank" href="http://getkirby.com/buy"><strong><?php _l('dashboard.index.license.buy') ?>&nbsp;&rsaquo;</strong></a>
            </p>
            <p style="margin-bottom: 0">
              <?php _l('dashboard.index.license.config') ?> <a target="_blank" href="http://getkirby.com/docs/installation/license-code"><strong>site/config/config.php</strong></a>
            </p>
          </div>
        </div>
